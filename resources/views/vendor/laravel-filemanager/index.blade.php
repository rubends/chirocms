...
<script>
    ...
    function useFile(file) {
        ...
        var opener_field_name = getUrlParam('opener_field_name');
        var addImage_func = getUrlParam('addImageFunction');
        ...
        if(window.opener || window.tinyMCEPopup || field_name || getUrlParam('CKEditorCleanUpFuncNum') || getUrlParam('CKEditor')) {
            ...
            if(addImage_func) {
                window.opener.addImage(url);
            }
            else if(opener_field_name) {

                window.opener.document.getElementById(opener_field_name).value = url;

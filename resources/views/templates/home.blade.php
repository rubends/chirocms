...
<div id="content">
    ...
    <div id="home-content">
        <div class="container cms-content">
            <div class="">
                <div class="col-sm-9 col-md-8 col-md-offset-1 mainbar">
                    {!! $page->content !!}
                </div>
                <div class="col-md-3 hidden-sm hidden-xs sidebar">
                    <div class="inschrijven">
                        <h3>inschrijven voor activiteiten:</h3>
                        <a href="http://www.inschrijvenchiro.be/" target="_blank" class="btn btn-inschrijven">Inschrijven</a>
                    </div>
